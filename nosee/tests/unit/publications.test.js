...
describe('publications.mappers', () => {
  describe('mapPublicationFormToAPI', () => {
    it('convierte formato de formulario a formato API correctamente', () => {
      ...
      try {
        const { mapPublicationFormToAPI } = require('@/features/publications/mappers');
  ...
  describe('mapDBPublicationToUI', () => {
    it('convierte datos de Supabase a formato UI', () => {
      try {
        const { mapDBPublicationToUI } = require('@/features/publications/mappers');
...
describe('PublicationValidation', () => {
  describe('price validation', () => {
    it('acepta precio válido (> 0)', () => {
      try {
        const { PublicationValidation } = require('@/features/publications/schemas');
    ...
    it('acepta decimales', () => {
      try {
        ...
        const result = PublicationValidation.price(1500.50);
  ...
  describe('description validation', () => {
    it('acepta descripción válida', () => {
      try {
        ...
        const result = PublicationValidation.description('Este es un buen producto');
...
describe('dateUtils', () => {
  describe('formatDistanceToNowInSpanish', () => {
    it('retorna "hace unos segundos" para fechas recientes', () => {
      const { formatDistanceToNowInSpanish } = require('@/features/publications/utils/dateUtils');
  ...
  describe('formatDate', () => {
    it('formatea fecha en formato legible', () => {
      const { formatDate } = require('@/features/publications/utils/dateUtils');
...
describe('publications.api', () => {
  ...
  it('exporta constantes de estado', () => {
    try {
      const { PUBLICATION_STATUS, SORT_OPTIONS } = require('@/services/api/publications.api');
