...
const features = [
  { icon: <TagIcon />, title: 'Publica precios', desc: 'Comparte precios de productos con foto como evidencia.' },
  { icon: <UsersIcon />, title: 'Valida con la comunidad', desc: 'La comunidad valida y reporta publicaciones en tiempo real.' },
  { icon: <ShieldIcon />, title: 'Datos confiables', desc: 'Sistema de reputación asegura información precisa.' },
];
...
export default function HomePage() {
  ...
  return (
    <main style={{ flex: 1, padding: '28px 16px', maxWidth: '800px', margin: '0 auto', width: '100%' }}>
      {/* Saludo */}
      <section style={{
        ...
        <p style={{ fontSize: '15px', color: 'var(--text-secondary)', lineHeight: '1.6', marginBottom: '20px' }}>
          ...
          <span style={{ color: 'var(--accent)', fontWeight: '600' }}>Universidad del Quindío</span>.
        </p>
